...
import com.lagradost.cloudstream3.MvvmMock.logError
...
val mapper: JsonMapper
    get() = APIHolder.mapper

// APIHolder moved to APIHolder.kt
...
data class SubtitleFile(
    ...
    constructor(lang: String, url: String) : this(lang, url, null)
