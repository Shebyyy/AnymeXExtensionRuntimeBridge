/*
 * Minimal standalone JNI header for AnymeX Extension Runtime Bridge (iOS)
 *
 * This provides just enough JNI type definitions for the Swift FFI bridge
 * to compile. The full JNI definitions come from the OpenJDK static libs
 * at link time.
 */

#ifndef ANYMEX_JNI_H_INCLUDED
#define ANYMEX_JNI_H_INCLUDED
...
typedef struct JNINativeInterface {
    ...
    jsize       (*GetSuperclass)(JNIEnv*, jclass);
    ...
    jobject     (*NewStringUTF)(JNIEnv*, const char*);
    ...
    jint        (*UnregisterNatives)(JNIEnv*, jclass, const JNINativeMethod*, jint);
